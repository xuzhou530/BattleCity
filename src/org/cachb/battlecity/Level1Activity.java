...
public class Level1Activity extends BaseGameActivity {
	...
	public void onLoadResources() {
		...
		mScrumTextureRegion = TextureRegionFactory.createTiledFromAsset(
				this.mScrumTexture, this, "scrum_tiled.png", 0, 0, 8, 4);
	...
	public Scene onLoadScene() {
		...
		final Sprite bullet = new Sprite(20.0f, CAMERA_HEIGHT - 40.0f,
		...
		final Sprite hatchet = new Sprite(cross.getInitialX() + 40.0f,
	...
	private Runnable mStartVamp = new Runnable() {
		public void run() {
			...
			asprVamp[i] = new AnimatedSprite(CAMERA_WIDTH - 30.0f, startY,
			...
			asprVamp[i].registerEntityModifier(new SequenceEntityModifier(
					new AlphaModifier(5.0f, 0.0f, 1.0f), new MoveModifier(
							60.0f, asprVamp[i].getX(), 30.0f, asprVamp[i]
									.getY(), (float) CAMERA_HEIGHT / 2)));
